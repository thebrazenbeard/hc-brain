...
Machine-readable counterparts and conformance checks live under `../specs/`, especially `HC_COGNITIVE_ORGAN_INVARIANTS_V1.yaml`, `HC_CONFORMANCE_SUITE_V1.yaml`, `HC_MEMORY_PROVIDER_BOUNDARY_V1.yaml`, and `HC_BOOTSTRAP_RECOVERY_V1.yaml`.
