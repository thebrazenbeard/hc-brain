...
| Somatics / body state / body schema | ARCHITECTURALLY_REQUIRED + SPECIFIED | REFERENCE_IMPLEMENTED for morphology-neutral calibration, pose update and reachability prediction | DEMONSTRATED_INTEGRATED with forecast lineage; motor control still incomplete | No | `somatics/`; `runtime/cognitive_core/homeostasis_somatics.py` |
